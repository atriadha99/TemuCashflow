...
public class DashboardActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        binding.tvGreeting.setText("Halo, " + userName + "!");
    ...
    private void loadData() {
        ...
        if (totalIncome > 0) {
            ...
            binding.tvBalancePercent.setText(balancePercent + "% Tersisa");
            ...
            binding.tvBalancePercent.setText("0%");
        }
    ...
    private void updateBudgetProgress() {
        ...
        if (budgetLimit > 0) {
            ...
            binding.tvBudgetText.setText(CurrencyFormatter.format(monthlyExpense) + " / " + CurrencyFormatter.format(budgetLimit));
            
            if (progress < 80) {
                binding.tvBudgetWarning.setText("Status: Baik");
                binding.tvBudgetWarning.setTextColor(ContextCompat.getColor(this, R.color.green_income));
                binding.budgetProgress.setIndicatorColor(ContextCompat.getColor(this, R.color.purple_primary));
            } else if (progress <= 100) {
                binding.tvBudgetWarning.setText("Status: Waspada");
                binding.tvBudgetWarning.setTextColor(ContextCompat.getColor(this, R.color.orange_warning));
                binding.budgetProgress.setIndicatorColor(ContextCompat.getColor(this, R.color.orange_warning));
            } else {
                binding.tvBudgetWarning.setText("Status: Buruk (Over)");
                binding.tvBudgetWarning.setTextColor(ContextCompat.getColor(this, R.color.red_expense));
                binding.budgetProgress.setIndicatorColor(ContextCompat.getColor(this, R.color.red_expense));
            }
        } else {
